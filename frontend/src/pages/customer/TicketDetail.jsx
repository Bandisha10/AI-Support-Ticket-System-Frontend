          ...
          <div className="mt-4 border-t border-surface-border pt-3">
            ...
            <div className="flex flex-wrap gap-2.5">
              {ticket.attachments.map((file, idx) => {
                const displayName = file.name || file.filename || `Attachment ${idx + 1}`;
                const isImage = isImageAttachment(displayName, file.content_type);
                ...
                return (
                  ...
                  >
                    ...
                    <span className="truncate max-w-[200px] font-medium">{displayName}</span>
                    {sizeLabel && (
                      <span className="text-[11px] text-gray-500">({sizeLabel})</span>
                    )}
